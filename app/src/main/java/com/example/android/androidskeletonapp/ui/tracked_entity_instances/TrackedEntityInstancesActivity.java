...
public class TrackedEntityInstancesActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.enrollmentButton).setOnClickListener(view -> {
            ...
            TrackedEntityInstanceCreateProjection trackedEntityInstanceCreateProjection =
            ...
            try{
                String uid = Sdk.d2().trackedEntityModule().trackedEntityInstances.add(trackedEntityInstanceCreateProjection);
