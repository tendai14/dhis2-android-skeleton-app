...
public class TrackedEntityInstanceSearchActivity extends ListActivity {
    ...
    private void searchTrackedEntityInstances() {
        ...
        List<OrganisationUnit> organisationUnits = Sdk.d2()
        ...
        TrackedEntityAttribute trackedEntityAttribute = Sdk.d2().trackedEntityModule().trackedEntityAttributes
                .byName()
        ...
        Program program = Sdk.d2().programModule().programs.one().get();
        ...
        TrackedEntityInstanceQuery query = TrackedEntityInstanceQuery.builder()
                ...
                .filter(Collections.singletonList(
                        QueryItem.create(trackedEntityAttribute.uid(), QueryFilter.builder()
    ...
    private LiveData<PagedList<TrackedEntityInstance>> getTrackedEntityInstanceList(TrackedEntityInstanceQuery query) {
        ...
        return Sdk.d2().trackedEntityModule().trackedEntityInstanceQuery.query(query).onlineFirst().getPaged(15);
    }
}
